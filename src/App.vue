...
export default {
  ...
  data () {
    return {
      ...
      experience: {
        lewagon: { id: 'lewagon', institution: 'le Wagon', title: 'Lecturer & Teaching Assistant', imageUrl: 'https://pbs.twimg.com/profile_images/1410515616897945601/9h_npQah_400x400.jpg', date: 'Apr 2020 - Present', text: 'I have been invited back to work as a teaching assistant and lecturer on the next cohorts of students. I am enjoying the challenge of deepening my understanding of core concepts.' },
